...
- [ ] **Step 3: Expose one canonical UTC timestamp validator**
...
- [ ] **Step 4: Implement the exact immutable task contracts**
...
- [ ] **Step 1: Write the legal-path and illegal-transition tests**
...
- [ ] **Step 3: Implement deterministic retry calculation**
...
- [ ] **Step 4: Implement immutable transition functions**
...
- [ ] **Step 1: Write exhaustive phase-edge tests**
...
- [ ] **Step 3: Implement the explicit forward graph**
...
- [ ] **Step 4: Implement task-derived progress and run status**
...
- [ ] **Step 1: Write the full dependency-matrix tests**
...
- [ ] **Step 3: Implement typed requests and plans**
...
- [ ] **Step 1: Write the failing replay test and fixture contract**
...
- [ ] **Step 3: Implement the checker using production code only**
...
- [ ] **Step 4: Document the delivered boundary in plain Chinese**
...
Request a strong-model review of all commits against this plan. Resolve findings with a failing regression test first, rerun the full gate, push a feature branch, create a PR against `master`, wait for Ubuntu 3.11/3.12/3.13 and Windows 3.12 CI, merge only when green, then verify the post-merge `master` CI.
